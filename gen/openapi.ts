...
export interface components {
  schemas: {
    ...
    AdvancementModel: {
      ...
      advancement: components["schemas"]["AdvancementSlot"][];
    };
    /** Advancement Order */
    AdvancementSlot: {
      /**
    ...
    AllianceSelectionDetailModel: {
      selections: components["schemas"]["SelectionModel"][];
      /** Format: int32 */
      count: number;
    };
    /** Alliance Selection */
    AllianceSelectionModel_Version2: {
      alliances: components["schemas"]["AllianceModel_Version2"][];
      /** Format: int32 */
      count: number;
    };
    /**
    ...
    AwardsModel: {
      awards: components["schemas"]["AwardAssignmentModel"][];
    };
    /** @enum {string} */
    ...
    EventMatchResultsModel_Version2: {
      matches: components["schemas"]["MatchResultModel_Version2"][];
    };
    /** Event Ranking List */
    EventRankingsModel: {
      Rankings: components["schemas"]["TeamRankingModel"][];
    };
    /** Hybrid Schedule */
    EventScheduleHybridModel_Version2: {
      schedule: components["schemas"]["ScheduleHybridModel_Version2"][];
    };
    /** Scheduled Match List */
    EventScheduleModel_Version2: {
      schedule: components["schemas"]["ScheduledMatchModel_Version2"][];
    };
    /** @enum {string} */
    ...
    Geometry: {
      coordinates: (readonly components["schemas"]["Coordinate"][]);
      /** Format: int32 */
      numPoints: number;
      isEmpty: boolean;
    ...
    MatchResultModel_Version2: {
      ...
      teams: components["schemas"]["MatchResultTeamModel_Version2"][];
      /** Format: date-time */
      modifiedOn: string;
    };
    /** Match Result Team */
    ...
    /** Match Score List */
    MatchScoresModel: {
      MatchScores: ((components["schemas"]["ScoreDetailModel_2019"] | components["schemas"]["ScoreDetailModel_2020"] | components["schemas"]["ScoreDetailModelSinglePlayer_2020"] | components["schemas"]["ScoreDetailModel_2021"] | components["schemas"]["ScoreDetailModelSinglePlayer_2021"] | components["schemas"]["ScoreDetailModel_2022"] | components["schemas"]["ScoreDetailModelSinglePlayer_2022"] | components["schemas"]["ScoreDetailModel_2023"] | components["schemas"]["ScoreDetailModelSinglePlayer_2023"])[]);
    };
    NtsGeometryServices: {
    ...
    ScheduledMatchModel_Version2: {
      ...
      /** Format: int32 */
      matchNumber: number;
      teams: components["schemas"]["ScheduledMatchTeamModel_Version2"][];
      /** Format: date-time */
      modifiedOn: string;
    };
    ...
    ScheduleHybridModel_Version2: {
      ...
      redWins: boolean;
      blueWins: boolean;
      teams: components["schemas"]["ScheduleHybridModelTeam_Version2"][];
    };
    ...
    ScoreDetailAllianceModel_2022: {
      ...
      autoJunctions: components["schemas"]["JunctionElement"][][][];
      ...
      dcJunctions: components["schemas"]["JunctionElement"][][][];
      /**
       * Format: int32
    ...
    ScoreDetailModel_2019: {
      ...
      /** Format: int32 */
      matchNumber: number;
      alliances: components["schemas"]["ScoreDetailModelAlliance_2019"][];
    };
    ...
    ScoreDetailModel_2020: {
      ...
      /** Format: int32 */
      matchNumber: number;
      alliances: components["schemas"]["ScoreDetailAllianceModel_2020"][];
    };
    ...
    ScoreDetailModel_2021: {
      ...
      alliances: components["schemas"]["ScoreDetailAllianceModel_2021"][];
    };
    ...
    ScoreDetailModel_2022: {
      ...
      /** Format: int32 */
      randomization: number;
      alliances: components["schemas"]["ScoreDetailAllianceModel_2022"][];
    };
    ScoreDetailModel_2023: {
      ...
      /** Format: int32 */
      randomization: number;
      alliances: components["schemas"]["ScoreDetailAllianceModel_2023"][];
    };
    ...
    ScoreDetailModelAlliance_2019: {
      ...
      autoStones: components["schemas"]["Stone"][];
      /** Format: int32 */
    ...
    SeasonAwardListingsModel: {
      awards: components["schemas"]["SeasonAwardsModel"][];
    };
    /** Award */
    SeasonAwardsModel: {
      /** Format: int32 */
    ...
    SeasonEventListingsModel_Version2: {
      events: components["schemas"]["SeasonEventModel_Version2"][];
      /** Format: int32 */
      eventCount: number;
    };
    /** Event */
    ...
    SeasonLeagueListingsModel_Version2: {
      leagues: components["schemas"]["SeasonLeagueModel_Version2"][];
      /** Format: int32 */
      leagueCount: number;
    };
    /** League */
    ...
    SeasonSummaryModel_Version2: {
      ...
      /** Format: int32 */
      teamCount: number;
      frcChampionships: components["schemas"]["SeasonSummaryModelChampionship"][];
    };
    ...
    SeasonTeamListingsModel_Version2: {
      teams: components["schemas"]["SeasonTeamModel_Version2"][];
      /** Format: int32 */
